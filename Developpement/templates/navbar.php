  <!-- NAVBAR TOP mobile qui sera display: none avec @media -->
      <!-- menu hamb fait maison -->
      <nav class="nav-top">
        <div class="icon-hamb">
      ...
      <nav class="navbar-side">
        <ul>
          ...
          <li>
            ...
            />
            <a href="./OrganisedTournament">Mes tournois</a>
          </li>
          <li>
            <img
            ...
            />
            <a href="./createTournament">Créer tournois</a>
          </li>
          <li>
            <img
              ...
              alt="Icone accueil"
            />
            <a href="./subTournament">Tournois rejoints</a>
          </li>
