...
<html lang="fr">
  <head>
    ...
    <link
      rel="stylesheet"
      href="./assets/css/createAndModificationTournament.css"
    />
    <title>Modification tournament GamingTournament</title>
  </head>
  <body>
    <header>
      ...
      <div class="container-form">
        <form action="" enctype="multipart/form-data">
          ...
          <div class="responsiv-param">
            <div class="container-parameter-form">
              ...
              <div class="general" id="info-general">
                ...
                <label for="banner"
                  >Bannière : <span>(.jpeg .jpg .webp)</span>
                  <input
                    type="file"
                    id="banner"
                    name="banner"
              ...
              <div class="responsiv-structure-info">
                ...
                <div class="container-radio">
                  ...
                  <input
                    ...
                    id="auto-sub-off"
                    value="auto-sub-off"
                  /><label for="auto-sub-off"> Non </label>
                </div>
              </div>
              <div class="responsiv-structure-info">
                <label for="rules">
          ...
          <div class="container-cta">
            <button class="cta">Modifier le tournoi</button>
          </div>
        </form>
      </div>
    </main>
    ...
    <script src="./assets/javascript/createAndModificationTournament.js"></script>
  </body>
</html>
