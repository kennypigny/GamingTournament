...
<html lang="fr">
  <head>
    ...
    <title>GamingTournament : Gestionnaire de tournoi</title>
    ...
    <link rel="stylesheet" href="./assets/css/tournamentManagement.css" />
  ...
  <body>
          ...
          <div class="container-info-description">
            ...
            <div class="container-button-info-general">
              <button class="button-info-general">
                <a href="./TournamentModifcation.html" target="_blank"
                  >Modifier</a
                >
              </button>
            </div>
              ...
              <div class="bottom-box-players">
                ...
                <table class="table-players">
                  ...
                  <tbody>
                    <!-- <tr>
                      <td>
                        <label for="list-player1" aria-label="Joueur inscrit"
                          ><input
                            type="checkbox"
                            name="list-player1"
                            id="list-player1"
            ...
            <div class="container-registration">
              ...
              <div class="auto-accept">
                ...
                <label for="auto-accept-yes"
                  ...
                  Oui</label
                >
                <label for="auto-accept-no"
                  ><input type="radio" id="auto-accept-no" name="auto-accept" />
                  Non</label
                >
              </div>
            </div>
    ...
    <script src="./assets/javascript/tournamentManagement.js"></script>
